...
if HAS_DECORATORS:
    vak_adaptation_agent = create_universal_pydantic_agent(
        model=create_llm_model(),
        deps_type=PatternVAKAdaptationDependencies,
        system_prompt=get_base_system_prompt(),
        agent_type="pattern_vak_adaptation_specialist",
        knowledge_tags=["pattern-vak-adaptation", "modality-adaptation", "agent-knowledge", "patternshift"],
