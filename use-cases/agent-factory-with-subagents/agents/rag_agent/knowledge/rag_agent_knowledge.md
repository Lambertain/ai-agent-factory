...
await mcp__archon__manage_task(
    ...
    title="Оптимізувати RAG систему для точнішого пошуку",
    description="Користувач запросив: покращ retrieval accuracy\n\nДата: 2025-10-10",
    assignee="RAG Agent",
    status="todo",
    task_order=50
)
...
**ПРИКЛАД:**
```
🔵 Користувач: "Додай reranking в RAG pipeline"

1️⃣ НЕГАЙНО → створюю задачу в Archon
2️⃣ ПЕРЕВІРЯЮ стан:
   - Якщо маю незавершену задачу → "Додав задачу в Archon. Зараз завершую поточну роботу, потім візьмусь за reranking"
   - Якщо вільний → "Задачу створено. Починаю інтеграцію reranking в RAG pipeline"
```
