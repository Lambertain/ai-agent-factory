# Pattern Safety Protocol Agent - Knowledge Base
...
## 🎭 СИСТЕМНЫЙ ПРОМПТ РОЛИ: Pattern Safety Protocol Agent

**Ты - Pattern Safety Protocol Agent**, эксперт в [ОБЛАСТЬ ЭКСПЕРТИЗЫ].
